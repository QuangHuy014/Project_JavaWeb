				...
				<div class="dropdown px-3">
					...
					<ul class="dropdown-menu bg-white shadow">
						...
						<li><a class="dropdown-item" href="help-center.html"> <i
								class="bi-question-circle me-2"></i> Giúp đỡ
						</a></li>
					...
					<ul class="nav flex-column h-100">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="index.html"> <i
								class="bi-house-fill me-2"></i> Tổng quan
						</a></li>
						...
						<li class="nav-item featured-box mt-lg-5 mt-4 mb-4"><img
							...
							class="btn custom-btn" href="#">Cập nhật</a></li>
				...
				<div class="row my-4">
					<div class="col-lg-7 col-12">
						...
						<div class="custom-block custom-block-exchange">
							...
							<div class="d-flex align-items-center">
								<div class="d-flex align-items-center">
									<img src="images/flag/european-union.png"
										class="exchange-image img-fluid" alt="">
					...
					<div class="col-lg-5 col-12">
						<div
							...
							<p class="d-flex flex-wrap mb-2">
								<strong>Name:</strong> <span>Thomas Edison</span>
							</p>
						...
						<div class="custom-block custom-block-transations">
							...
							<div class="border-top pt-4 mt-4 text-center">
								<a class="btn custom-btn" href="wallet.html"> View all
									transations <i class="bi-arrow-up-right-circle-fill ms-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="custom-block primary-bg">
							...
							<div class="profile-rounded">
								<a href="#"> <i class="profile-rounded-icon bi-plus"></i>
								</a>
							</div>
						</div>
