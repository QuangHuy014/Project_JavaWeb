				...
				<div class="position-sticky py-4 px-3 sidebar-sticky">
					<ul class="nav flex-column h-100">
						...
						<li class="nav-item"><a class="nav-link active"
							href="wallet.html"> <i class="bi-wallet me-2"></i> My Wallet
						</a></li>
								...
								<table class="account-table table">
									...
									<tbody>
										<tr>
											...
											<td class="text-danger" scope="row"><span class="me-1">-</span>
												$100.00</td>

											<td scope="row">$5,500.00</td>

											<td scope="row"><span class="badge text-bg-danger">
													Pending </span></td>
										</tr>
										...
										<tr>
											...
											<td class="text-success" scope="row"><span class="me-1">+</span>
												$250</td>
										...
										<tr>
											...
											<td class="text-success" scope="row"><span class="me-2">+</span>$50</td>
										...
										<tr>
											...
											<td class="text-danger" scope="row"><span class="me-2">-</span>$380</td>

											<td scope="row">$5,300.00</td>

											<td scope="row"><span class="badge text-bg-dark">
													Cancelled </span></td>
										</tr>
										...
										<tr>
											...
											<td class="text-success" scope="row"><span class="me-2">+</span>$250</td>
										...
										<tr>
											...
											<td class="text-danger" scope="row"><span class="me-2">-</span>$500</td>
										...
										<tr>
											...
											<td class="text-success" scope="row"><span class="me-2">+</span>$856</td>
						...
						<div class="custom-block custom-block-bottom d-flex flex-wrap">
							<div class="custom-block-bottom-item">
								<a href="#" class="d-flex flex-column"> <i
									class="custom-block-icon bi-wallet"></i> <small>Top up</small>
								</a>
							</div>

							<div class="custom-block-bottom-item">
								<a href="#" class="d-flex flex-column"> <i
									class="custom-block-icon bi-upc-scan"></i> <small>Scan
										& Pay</small>
								</a>
							</div>
							...
							<div class="custom-block-bottom-item">
								<a href="#" class="d-flex flex-column"> <i
									class="custom-block-icon bi-send"></i> <small>Send</small>
								</a>
							</div>

							<div class="custom-block-bottom-item">
								<a href="#" class="d-flex flex-column"> <i
									class="custom-block-icon bi-arrow-down"></i> <small>Request</small>
								</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-5 col-12">
						<div class="custom-block custom-block-transations">
							...
							<div class="d-flex flex-wrap align-items-center mb-4">
								...
								<div class="ms-auto">
									<small>05/12/2023</small> <strong class="d-block text-danger"><span
										class="me-1">-</span> $250</strong>
								</div>
							</div>
							...
							<div class="d-flex flex-wrap align-items-center">
								<div class="d-flex align-items-center">
									...
									<div>
										<p>
											<a href="transation-detail.html">Store</a>
										</p>
