...
<body class="img js-fullheight" style="background-image: url(https://nhathuoclongchau.com.vn/estore-images/home/heath/heath-check.png);">
	...
	<script src="<c:url value='/template/web/login-form-20/login-form-20/bootstrap.min.js'/>"></script>
	<script src="<c:url value='/template/web/login-form-20/login-form-20/jquery.min.js'/>"></script>
	<script src="<c:url value='/template/web/login-form-20/login-form-20/main.js'/>"></script>
	<script src="<c:url value='/template/web/login-form-20/login-form-20/popper.js'/>"></script>
</body>
</html>
